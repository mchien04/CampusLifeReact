...
import TaskProofGallery from '../../components/preparation/TaskProofGallery';
import {
    ActivityBudgetDto,
    ActivityResponse,
                                            ...
                                            {dashboard.tasks.map((t: PreparationTaskDto) => (
                                                <tr key={t.id}>
                                                    <td className="px-4 py-3">
                                                        ...
                                                        {t.completionProofUrls && t.completionProofUrls.length > 0 && (
                                                            <div className="text-xs text-blue-600 mt-1 font-medium flex items-center gap-1">
                                                                ...
                                                                Đính kèm {t.completionProofUrls.length} minh chứng
                                                            </div>
                                                        )}
                                                    </td>
                                ...
                                <>
                                    <div className="card overflow-hidden">
                                        ...
                                        <div className="p-5 space-y-3 bg-white">
                                            ...
                                            {taskForMembers.completionProofUrls && taskForMembers.completionProofUrls.length > 0 && (
                                                <div className="pt-2 border-t border-gray-100">
                                                    <TaskProofGallery proofUrls={taskForMembers.completionProofUrls} />
                                                </div>
                                            )}
